...
namespace  WodorNet\MotoTripBundle\DependencyInjection\Compiler;

use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;

class MotoTripConfigurationPass implements CompilerPassInterface
{
    /**
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds('wodor_net_moto_trip.subscriber') as $id => $attributes) {
